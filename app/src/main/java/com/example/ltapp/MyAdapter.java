...
/**
 * job of the MyAdapter class is to put dta into a each row of the listview
 */
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.WordViewHolder> {
    ...
    /**
     * 3
     * onBindViewHolder job is to write the data on the planks
     * @param holder
     * @param position
     */
    @Override
    public void onBindViewHolder(@NonNull MyAdapter.WordViewHolder holder, int position) {
        holder.tittleTextView.setText(languages[position]);

    }

    /**
     * 1
     * getItemCount job is to keep the count of no of data items in the dataset
     * @return
     */
    @Override
    ...
    /**
     * WordViewHolder job is to hold the recycle the stock and new stack of wooden planks
     */
    public class WordViewHolder extends RecyclerView.ViewHolder{
        public TextView tittleTextView;
        public WordViewHolder(@NonNull View itemView) {
            super(itemView);
            tittleTextView = itemView.findViewById(R.id.textViewRow);
        }
    }
}
